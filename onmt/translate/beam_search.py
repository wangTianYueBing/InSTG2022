...
class BeamSearch(DecodeStrategy):
    ...
    def advance(self, log_probs, attn, attn_key):
        ...
        # print("self.select_indices", self.alive_seq)
        # Append last prediction.
        x = torch.rand(5, 4)
        y = torch.rand(5, 4)
        # print("x = torch.rand(5, 4)", self.alive_seq.index_select(0, x))
        self.select_indices = self.select_indices.type(torch.int64)
