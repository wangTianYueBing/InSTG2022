...
class ReportMgr(ReportMgrBase):
    ...
    def _report_step(self, lr, step, train_stats=None, valid_stats=None):
        ...
        if train_stats is not None:
            ...
            f = open("loggggg.txt", "a+")
            f.write('Train perplexity: %g' % train_stats.ppl())
            f.write('Train accuracy: %g' % train_stats.accuracy())
            f.close()
        ...
        if valid_stats is not None:
            ...
            f = open("loggggg.txt", "a+")
            f.write('Validation perplexity: %g\n' % valid_stats.ppl())
            f.write('Validation accuracy: %g\n' % valid_stats.accuracy())
            f.close()
